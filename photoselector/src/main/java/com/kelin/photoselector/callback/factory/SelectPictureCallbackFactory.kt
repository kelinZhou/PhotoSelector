 ...
 * **版本:** v 1.0.0
 */
internal class SelectPictureCallbackFactory<R>(private val albumType: AlbumType, private val maxLength: Int, private val id: Int, private val maxDuration: Long) : CallbackFactory<R?> {
